...
define('components/comment/delete',[
    'react'
], function(
    React
){
    var CommentDeleteComponent = React.createClass({displayName: "CommentDeleteComponent",
        delete: function(e) {
            e.preventDefault();
        ...
        render: function(){
            return (
                React.createElement("a", {href: "#", onClick: this.delete}, "×")
            )
        }
    });
...
define('components/comment/item',[
    'react',
    'components/comment/delete'
], function(
    React,
    CommentDeleteComponent
){
    var CommentItemComponent = React.createClass({displayName: "CommentItemComponent",
        ...
        render: function(){
            ...
            return (
                React.createElement("li", null, 
                    React.createElement("strong", {className: "fullnamecomment", style: style}, this.state.fullname), 
                    React.createElement("p", null, this.props.dulieu.text), 
                    React.createElement(CommentDeleteComponent, {showerror: this.props.showerror})
                )
            )
        }
    });
...
define('components/comment/commentlist',[
    'react',
    ...
    var CommentListComponent = React.createClass({displayName: "CommentListComponent",
        getInitialState: function() {
            return {
                comments: []
            }
        ...
        render: function(){
            ...
            return (
                React.createElement("div", null, 
                    React.createElement("h1", null, "Comment List"), 
                    React.createElement("ol", null, 
                    
                        this.state.comments.length > 0 ? (
                            React.createElement("div", null, "Found ", this.state.comments.length, " item(s): ", React.createElement("br", null), 
                            
                                this.state.comments.map(function(item) {
                                    return (
                                        React.createElement(CommentItemComponent, {showerror: self.props.showErrorFromParent, ref: "commentitem-" + item.id, key: item.id, dulieu: item})
                                    )
                                })
...
define('components/comment',[
    ...
    var CommentComponent = React.createClass({displayName: "CommentComponent",
        ...
        render: function(){
            return (
                React.createElement("form", {className: "ui form", method: "POST"}, 
                  React.createElement("div", {className: "field"}, 
                    React.createElement("label", null, "Your Name"), 
                    React.createElement("input", {type: "text", name: "fullname", placeholder: "Your name"})
                  ), 

                  React.createElement("div", {className: "field"}, 
                    React.createElement("label", null, "Leave your comment:"), 
                    React.createElement("textarea", {rows: "3"})
                  ), 

                  React.createElement("button", {className: "ui green button", type: "submit"}, "Submit"), 

                  React.createElement("button", {className: "ui blue button", onClick: this.changeColor, type: "button"}, "Change Color"), 

                  React.createElement(CommentListComponent, {ref: "commentlist", showErrorFromParent: this.showError})
                )
...
define('components/welcome',[
    'react'
], function(
    React
){
    var WelcomeComponent = React.createClass({displayName: "WelcomeComponent",
        render: function(){
            return (
